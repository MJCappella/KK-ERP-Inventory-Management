        ...
        <div class="card">
            ...
            <form method="POST" action="{{ route('products.update', $product) }}" class="p-6 space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <label for="name" class="filter-label">Product Name <span class="text-red-600 text-sm">*</span>
                        </label>
                    ...
                    <div>
                        <label for="sku" class="filter-label">SKU Code (Unique) <span class="text-red-600 text-sm">*</span>
                        </label>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                        <label for="category" class="filter-label">Category <span class="text-red-600 text-sm">*</span>
                        </label>
                        <input type="text" id="category" name="category" value="{{ old('category', $product->category) }}"
                            required class="form-input text-sm">
                    </div>

                    <div>
                        <label for="unit" class="filter-label">Unit of Measure <span class="text-red-600 text-sm">*</span>
                        </label>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <input type="number" id="selling_price" name="selling_price"
                            ...
                            class="form-input text-sm font-mono font-bold text-sky-700">
                    </div>
                ...
                <div>
                    ...
                    <textarea id="description" name="description" rows="3"
                        class="form-textarea text-xs">{{ old('description', $product->description) }}</textarea>
                </div>
